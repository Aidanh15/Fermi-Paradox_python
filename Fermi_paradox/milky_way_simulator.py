...
SCALE = 225 # Earths radio bubble is at 255

# No. of predicted advanced civilisations from drake equation:
NUM_CIVS = 15600000

# Canvas to display galaxy on:
root = tk.Tk()
...
# Actual Milky Way dimensions in light years (NASA)
DISC_RADIUS = 50000
DISC_HEIGHT = 1000
